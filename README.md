...
| **Sync** | Card grid: Fetch, Fetch+prune, Pull, Pull --rebase, Push, Push --force-with-lease. Remote management. |
| **History** | Commit log with message search, commit detail card (subject + body + author chip + SHA pills), inline diff with sticky file headers, "Open in viewer" for tree-pane navigation. |
